	...
	$('#example').DataTable( {
		...
		columns: [
			...
			{ data: null, render: function ( data, type, row, meta ) {
				return '<a href="attendance_list.php?id=' + data.enrollment_list.barcode + '">View</a>';
				}
			},
			...
			<!-- <form class="form-inline" action="enrollment_list.php">
				<div class="form-group">
					...
					<select class="form-control" id="schoolyear" name="sy">
						<option <?php if(($_GET['sy']=="2020-2021")){ echo "selected"; } ?>>2020-2021</option>
						<option <?php if(($_GET['sy']=="2021-2022")){ echo "selected"; } ?>>2021-2022</option>
						<option <?php if(($_GET['sy']=="2022-2023")){ echo "selected"; } ?>>2022-2023</option>
						<option <?php if(($_GET['sy']=="") or ($_GET['sy']=="2023-2024")){ echo "selected"; } ?>>2023-2024</option>
					</select>
				</div>
