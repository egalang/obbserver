			...
			{ data: "enrollment_list.accepted" },
      {
          ...
          title: "Image"
			...
			{ data: null, render: function ( data, type, row, meta ) {
				...
				if (data.enrollment_list.accepted == "N") {
					btns = btns + ' <a class="btn btn-info btn-xs" href="review_parent.php?id=' + data.enrollment_list.id + '">Review Application</a>';
				}
				if (data.enrollment_list.sy == "2023-2024") {
					btns = btns + ' <a class="btn btn-warning btn-xs" href="re-enroll.php?id=' + data.enrollment_list.id + '">Enroll next level</a>';
				}
				if (data.enrollment_list.card == "Y") {
					btns = btns + ' <a class="btn btn-danger btn-xs" href="report_card_online.php?id=' + data.enrollment_list.id + '" target="_blank">View Report Card</a>';
				}
				return btns;
			}
		}
