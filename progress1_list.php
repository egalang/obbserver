	...
	$('#example').DataTable( {
		...
		columns: [
			...
			{ data: null, render: function ( data, type, row, meta ) {
				return '<a href="progress_report.php?cid=<?php echo $course_id; ?>&pid='
						+ data.id 
						+ '" target = "_new">' + data.name + '</a>';
				}
			},
			{ data: "code" }
		],
...
<body class="dt-example dt-example-bootstrap">
	<div class="container">
		<section>
			...
			<h1><span><a href = "progress0_list.php"><?php echo $course_name; ?></a> | <b>Grading Periods</b></span></h1>
			<br>
